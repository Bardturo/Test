...
knitr::opts_chunk$set(warning = F, message = F, echo = T, tidy = "styler") #Remove code, warnings, messages from pdf
...
The following is a coding task I have completed for a different position's application process. The data is simulated information from a particular childcare center's work shifts and child visits. Each row in the data represents a child's stay at the center, including information on their caregiver, their check-in and pick-up times, and their caregiver's shift times. There is a small sample of the data at the bottom of the page.

```{=latex}
%% This table appears at the bottom of the page in the knitted output.
\begin{table}
\begin{center}
\begin{tblr}{
  colspec={Q[]Q[]Q[]Q[]Q[]Q[]},
